...
b_q = pg.transform.scale(pg.image.load("images/b_q.png"), (PIECE_SIZE, PIECE_SIZE))
b_k = pg.transform.scale(pg.image.load("images/b_k.png"), (PIECE_SIZE, PIECE_SIZE))
b_n = pg.transform.scale(pg.image.load("images/b_n.png"), (PIECE_SIZE, PIECE_SIZE))
b_r = pg.transform.scale(pg.image.load("images/b_r.png"), (PIECE_SIZE, PIECE_SIZE))
b_p = pg.transform.scale(pg.image.load("images/b_p.png"), (PAWN_SIZE, PAWN_SIZE))
b_b = pg.transform.scale(pg.image.load("images/b_b.png"), (PIECE_SIZE, PIECE_SIZE))
w_q = pg.transform.scale(pg.image.load("images/w_q.png"), (PIECE_SIZE, PIECE_SIZE))
w_k = pg.transform.scale(pg.image.load("images/w_k.png"), (PIECE_SIZE, PIECE_SIZE))
w_n = pg.transform.scale(pg.image.load("images/w_n.png"), (PIECE_SIZE, PIECE_SIZE))
w_r = pg.transform.scale(pg.image.load("images/w_r.png"), (PIECE_SIZE, PIECE_SIZE))
w_p = pg.transform.scale(pg.image.load("images/w_p.png"), (PAWN_SIZE, PAWN_SIZE))
w_b = pg.transform.scale(pg.image.load("images/w_b.png"), (PIECE_SIZE, PIECE_SIZE))
...
def play(game):
    ...
    while playing:
        ...
        if captured:
            ...
            print([str(piece) for piece in captured_list])
